...
int MMG2D_mmg2d1n(void *buffers[], void *cl_arg, MMG5_pMesh ,MMG5_pSol, int);
int MMG2D_anatri(void *buffers[], void *cl_arg, MMG5_pMesh ,MMG5_pSol ,int8_t, int);
int MMG2D_adptri(void *buffers[], void *cl_arg, MMG5_pMesh ,MMG5_pSol, int);
...
int MMG2D_anaelt(void *buffers[], void *cl_arg, MMG5_pMesh ,MMG5_pSol ,int, int);
int MMG2D_colelt(void *buffers[], void *cl_arg, MMG5_pMesh ,MMG5_pSol ,int, int);
int MMG2D_swpmsh(void *buffers[], void *cl_arg, MMG5_pMesh ,MMG5_pSol ,int, int);
...
int MMG2D_dichoto(void *buffers[], void *cl_arg, MMG5_pMesh ,MMG5_pSol ,int ,int *, int);
...
int MMG2D_adpspl(void *buffers[], void *cl_arg, MMG5_pMesh ,MMG5_pSol, int);
int MMG2D_adpcol(void *buffers[], void *cl_arg, MMG5_pMesh ,MMG5_pSol,int);
int MMG2D_movtri(void *buffers[], void *cl_arg, MMG5_pMesh ,MMG5_pSol ,int ,int8_t, int);
